...
export class SearchPipe implements PipeTransform
{
  transform(items: Array<Customer>, customer: Customer)
  {
    return items
      ...
      .filter((item: Customer) => { return item.birthDate.formatted.indexOf(customer.birthDate.formatted) !== -1 || customer.birthDate.formatted === undefined || customer.birthDate ! == null})
